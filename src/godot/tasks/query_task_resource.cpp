...
void QueryTaskResource::_bind_methods() {
    ...
    godot::ClassDB::bind_method(godot::D_METHOD("set_logic_id", "logic_id"), &QueryTaskResource::set_logic_id);
    godot::ClassDB::bind_method(godot::D_METHOD("get_logic_id"), &QueryTaskResource::get_logic_id);
...
void QueryTaskResource::set_logic_id(uint32_t p_id) {
    logic_id = p_id;
}

uint32_t QueryTaskResource::get_logic_id() const {
    return logic_id;
}
} // namespace ideam::godot_ext