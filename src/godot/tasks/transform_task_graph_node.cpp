...
TransformTaskGraphNode::TransformTaskGraphNode() {
}

void TransformTaskGraphNode::_rebuild_dynamic_ui() {
    ...
    Dictionary matrix = core::NativeTaskRegistry::get_ui_transform_matrix();
...
uint64_t TransformTaskGraphNode::_calculate_flat_index() const {
...
void TransformTaskGraphNode::_populate_view_dropdown() {
...
void TransformTaskGraphNode::_populate_strategy_dropdown() {
...
void TransformTaskGraphNode::_populate_type_dropdown() {
