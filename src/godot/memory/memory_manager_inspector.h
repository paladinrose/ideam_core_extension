...
class MemoryManagerInspector : public IdeamEditorInspectorPlugin {
    GDCLASS(MemoryManagerInspector, IdeamEditorInspectorPlugin)

protected:
    static void _bind_methods();
    void _on_open_profiler_pressed(godot::Object* p_object);

public:
    MemoryManagerInspector();
    virtual ~MemoryManagerInspector() override;
