...
enum class QueryLogicID : uint32_t {
    ...
    Morphological_Static_Moore_R2,
    Morphological_Static_Moore_R3,
    Morphological_Static_VonNeumann_R1,
    Morphological_Static_VonNeumann_R2,
    Morphological_Static_VonNeumann_R3,
    PagedToTiledBridge,
    Predicate,
    RelationalBridge,
