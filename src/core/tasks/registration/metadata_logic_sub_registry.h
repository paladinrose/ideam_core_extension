...
struct MetadataLogicSubRegistry {
    ...
    static void init_execution_routing() {
        _fill_matrix<false>(std::make_index_sequence<MetadataTaskRegistry::SUB_MATRIX_SIZE>{});
    }
    ...
    static void generate_ui_matrices() {
        _fill_matrix<true>(std::make_index_sequence<MetadataTaskRegistry::SUB_MATRIX_SIZE>{});
    }
