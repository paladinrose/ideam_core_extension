#ifndef IDEAM_CORE_VALUE_ACCUMULATION_TRANSFORM_LOGIC_H
#define IDEAM_CORE_VALUE_ACCUMULATION_TRANSFORM_LOGIC_H
...
#endif // IDEAM_CORE_VALUE_ACCUMULATION_TRANSFORM_LOGIC_H