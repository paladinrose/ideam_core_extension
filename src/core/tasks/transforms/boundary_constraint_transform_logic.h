#ifndef IDEAM_CORE_BOUNDARY_CONSTRAINT_TRANSFORM_LOGIC_H
#define IDEAM_CORE_BOUNDARY_CONSTRAINT_TRANSFORM_LOGIC_H
...
#endif // IDEAM_CORE_BOUNDARY_CONSTRAINT_TRANSFORM_LOGIC_H