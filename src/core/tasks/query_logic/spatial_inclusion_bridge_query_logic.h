#ifndef IDEAM_CORE_SPATIAL_INCLUSION_BRIDGE_QUERY_LOGIC_H
#define IDEAM_CORE_SPATIAL_INCLUSION_BRIDGE_QUERY_LOGIC_H
...
#endif // IDEAM_CORE_SPATIAL_INCLUSION_BRIDGE_QUERY_LOGIC_H