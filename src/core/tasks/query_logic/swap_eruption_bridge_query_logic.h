#ifndef IDEAM_CORE_SWAP_ERUPTION_BRIDGE_QUERY_LOGIC_H
#define IDEAM_CORE_SWAP_ERUPTION_BRIDGE_QUERY_LOGIC_H
...
#endif // IDEAM_CORE_SWAP_ERUPTION_BRIDGE_QUERY_LOGIC_H